...
def init_model(kernel_size,num_filters,unfoldings,lmbda_prox,stride,multi_theta,verbose,beta,mu,e, gamma_1, gamma_2,l):
    params = STARNetParams(kernel_size=kernel_size,
                           ...
                           verbose=verbose,beta=beta, mu=mu, e=e, gamma_1=gamma_1, gamma_2=gamma_2, l=l)
